...
export const SEMANTIC_TYPOGRAPHY_TOKEN_NAMES = {
    ...
    SEMANTIC_TYPOGRAPHY_FORM_INPUT_FONT_SIZE:
        'SEMANTIC_TYPOGRAPHY_FORM_INPUT_FONT_SIZE',
    // Marketing
    SEMANTIC_TYPOGRAPHY_MARKETING_FONT_WEIGHT:
        'SEMANTIC_TYPOGRAPHY_MARKETING_FONT_WEIGHT',
    SEMANTIC_TYPOGRAPHY_MARKETING_XLARGE_FONT_SIZE:
        'SEMANTIC_TYPOGRAPHY_MARKETING_XLARGE_FONT_SIZE',
    SEMANTIC_TYPOGRAPHY_MARKETING_LARGE_FONT_SIZE:
        'SEMANTIC_TYPOGRAPHY_MARKETING_LARGE_FONT_SIZE',
    // Display
...
export const SEMANTIC_TYPOGRAPHY_RESPONSIVE_MOBILE_STYLE_TOKEN_NAMES = {
    ...
    SEMANTIC_TYPOGRAPHY_FORM_INPUT_MOBILE_FONT_SIZE:
        'SEMANTIC_TYPOGRAPHY_FORM_INPUT_MOBILE_FONT_SIZE',
    // Marketing
    SEMANTIC_TYPOGRAPHY_MARKETING_XLARGE_MOBILE_FONT_SIZE:
        'SEMANTIC_TYPOGRAPHY_MARKETING_XLARGE_MOBILE_FONT_SIZE',
    SEMANTIC_TYPOGRAPHY_MARKETING_LARGE_MOBILE_FONT_SIZE:
        'SEMANTIC_TYPOGRAPHY_MARKETING_LARGE_MOBILE_FONT_SIZE',
    // Display
...
export const SEMANTIC_TYPOGRAPHY_TOKEN_DEFAULTS = {
    ...
    // Marketing
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_MARKETING_FONT_WEIGHT]:
        'bold',
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_MARKETING_XLARGE_FONT_SIZE]:
        webFontSizes.marketingXLarge,
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_MARKETING_LARGE_FONT_SIZE]:
        webFontSizes.marketingLarge,
    // Display
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_FONT_WEIGHT]:
        'bold',
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_XLARGE_FONT_SIZE]:
        webFontSizes.displayXLarge,
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_LARGE_FONT_SIZE]:
        webFontSizes.displayLarge,
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_MEDIUM_FONT_SIZE]:
        webFontSizes.displayMedium,
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_SMALL_FONT_SIZE]:
        webFontSizes.displaySmall,
    // Headings Font Family
    ...
    // Body Line Height
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_LINE_HEIGHT]: 1.5,
    // Small
...
export const SEMANTIC_TYPOGRAPHY_RESPONSIVE_MOBILE_STYLE_TOKEN_DEFAULTS = {
    ...
    [SEMANTIC_TYPOGRAPHY_RESPONSIVE_MOBILE_STYLE_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_FORM_INPUT_MOBILE_FONT_SIZE]:
        webFontSizes.formInput,
    // Marketing
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_MARKETING_XLARGE_MOBILE_FONT_SIZE]:
        webFontSizes.marketingXLarge,
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_MARKETING_LARGE_MOBILE_FONT_SIZE]:
        webFontSizes.marketingLarge,
    // Display
    [SEMANTIC_TYPOGRAPHY_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_XLARGE_MOBILE_FONT_SIZE]:
        mobileFontSizes.displayXLarge,
    [SEMANTIC_TYPOGRAPHY_RESPONSIVE_MOBILE_STYLE_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_LARGE_MOBILE_FONT_SIZE]:
        mobileFontSizes.displayLarge,
    [SEMANTIC_TYPOGRAPHY_RESPONSIVE_MOBILE_STYLE_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_MEDIUM_MOBILE_FONT_SIZE]:
        mobileFontSizes.displayMedium,
    [SEMANTIC_TYPOGRAPHY_RESPONSIVE_MOBILE_STYLE_TOKEN_NAMES.SEMANTIC_TYPOGRAPHY_DISPLAY_SMALL_MOBILE_FONT_SIZE]:
        mobileFontSizes.displaySmall,
    // H1
