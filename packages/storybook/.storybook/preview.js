...
const preview = {
    parameters: {
        ...
        options: {
            ...
            // storySort: {
            //     order: [
            //         getLocale('titles.foundation'),
            //         [getLocale('stories.foundation.guidingPrinciples.title'), getLocale('titles.accessibility')],
            //         getLocale('titles.components'),
            //         getLocale('titles.developers'),
            //         getLocale('titles.designers'),
            //         '*',
            //     ],
            // },
            storySort: {
