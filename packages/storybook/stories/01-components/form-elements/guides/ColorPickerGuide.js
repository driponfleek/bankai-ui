...
class ColorPickerGuide extends PureComponent {
    static defaultProps = {
    ...
    static displayName =
        locale.stories.components.formElements.colorPicker.title;
    ...
    baseCls = 'bankai-sb-color-picker-guide';
}

export default ColorPickerGuide;
