...
import packageJSON from '@epr0t0type/bankai-ui-typography/package.json';
...
// Styles
// import './styles/heading-guide.scss';

const { bankaiUI: locale } = strings;

class HeadingGuide extends PureComponent {
    static defaultProps = {
        headingLvl: 2,
    };
    ...
    static displayName = locale.stories.components.typography.heading.title;
    ...
    render() {
        return (
            <StoryLayout
                ...
                title={locale.stories.components.typography.heading.title}
        ...
        return (
            <StorySection>
                <ComponentPreview shouldCheckA11Y>
                    <Heading {...props}>Heading Text</Heading>
                </ComponentPreview>
    ...
    baseCls = 'bankai-sb-heading-guide';
}
