...
class LoadingDotsGuide extends PureComponent {
    static defaultProps = {
        variant: BOUNCE,
    };
    ...
    static displayName = locale.stories.components.loading.loadingDots.title;
    ...
    baseCls = 'bankai-sb-loading-dots-guide';
}

export default LoadingDotsGuide;
