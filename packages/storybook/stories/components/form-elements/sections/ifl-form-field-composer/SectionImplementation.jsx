...
const importCodeStr = `import { IFLFormFieldComposer, TextInput } from '@driponfleek/bankai-ui-form-elements';`;
const usageCodeStr = `const TextField = IFLFormFieldComposer(TextInput);
