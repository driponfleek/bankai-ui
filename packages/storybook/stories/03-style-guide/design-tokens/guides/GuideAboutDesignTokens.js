...
// Styles
// import './styles/guide-about-design-tokens.scss';

const { bankaiUI: locale } = strings;

class GuideAboutDesignTokens extends PureComponent {
    render() {
        return (
            <StoryLayout
    ...
    baseCls = 'banka-sb-guide-about-design-tokens';
}

export default GuideAboutDesignTokens;
